    ...
    <div className={`rounded-2xl border transition-all duration-200 flex flex-col shadow-sm w-full max-w-full relative ${
      ...
      <div className={`px-3 sm:px-4 py-2.5 sm:py-3 border-b flex flex-wrap items-center justify-between gap-2 sm:gap-3 ${
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <span className="text-xl sm:text-2xl shrink-0">{currentKeyboard.flag || '🌐'}</span>
          <div>
            <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
              <h2 className="text-sm sm:text-base font-extrabold text-emerald-500 font-sans tracking-wide">
                {currentKeyboard.name.toLowerCase()}
              </h2>
              <span className={`text-sm sm:text-base font-bold text-emerald-600 ${currentKeyboard.fontFamilyClass || ''}`}>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap ml-auto">
          ...
          <select
            ...
            className={`text-xs font-semibold rounded-lg px-2.5 sm:px-3 py-1.5 border transition-all cursor-pointer outline-hidden touch-manipulation max-w-[150px] sm:max-w-[220px] truncate ${
              isDarkMode 
          ...
          {currentKeyboard.sampleText && (
            <button
              ...
              className="text-xs font-semibold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 px-2 sm:px-2.5 py-1.5 rounded-lg transition-colors cursor-pointer touch-manipulation active:scale-95"
            >
              Sample
            </button>
          )}
          ...
          <div className={`flex items-center rounded-lg border p-0.5 ${
            ...
            <button
              ...
              title="Zoom Out"
              className="p-1 sm:p-1.5 text-slate-400 hover:text-slate-200 rounded cursor-pointer touch-manipulation active:scale-95"
            >
              <ZoomOut className="w-3.5 h-3.5" />
            </button>
            <span className="text-[11px] sm:text-xs px-1 sm:px-2 font-mono font-medium min-w-6 sm:min-w-8 text-center">
              {activeFontSize}px
            </span>
            <button
      ...
      {/* Main Textarea Area */}
      <div className="p-3 sm:p-4 md:p-5 flex flex-col gap-2.5 sm:gap-3">
        <textarea
          ref={textareaRef}
          ...
          className={`w-full min-h-[110px] sm:min-h-[140px] md:min-h-[160px] p-3 sm:p-4 rounded-xl border focus:outline-hidden transition-all resize-y font-sans shadow-inner touch-manipulation ${
            isDarkMode 
        ...
        <div className={`flex items-center justify-between text-xs px-2.5 py-1.5 rounded-lg border gap-2 ${
          ...
          {currentKeyboard.hasPhoneticMode && onTogglePhoneticMode && (
            <button
              ...
              className={`flex items-center gap-1 px-2 py-0.5 rounded text-[11px] font-bold transition-all cursor-pointer border touch-manipulation active:scale-95 shrink-0 ${
                phoneticMode 
        ...
        <div className={`flex items-center justify-between pt-2 border-t flex-wrap gap-2 ${
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            <button
              ...
              onClick={handleCopy}
              disabled={!text}
              className={`flex items-center gap-1.5 text-xs font-semibold px-2.5 sm:px-3 py-2 rounded-lg border transition-all cursor-pointer shadow-xs disabled:opacity-40 active:scale-95 touch-manipulation min-h-[38px] ${
                copied 
            ...
            <button
              ...
              disabled={!text}
              title={t.clearText}
              className={`flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-lg border transition-all cursor-pointer shadow-xs disabled:opacity-30 active:scale-95 touch-manipulation ${
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
            ...
            <button
              ...
              className={`p-2 rounded-lg border transition-all cursor-pointer touch-manipulation active:scale-95 min-h-[38px] min-w-[38px] flex items-center justify-center ${
                speaking
        ...
        <div className={`mt-1 pt-2 border-t flex items-center justify-between text-[11px] px-1 ${
