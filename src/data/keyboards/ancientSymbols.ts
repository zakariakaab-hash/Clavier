...
export const morseCodeKeyboard: KeyboardLayout = {
  id: 'morse',
  name: 'Morse Code (with Audio Synthesizer)',
  nativeName: 'Morse Code (.-)',
  category: 'math-symbols',
  region: 'International Telegraphy',
  direction: 'ltr',
  isoCode: 'mor',
  flag: '📻',
  description: 'International Morse Code keyboard with interactive Dot / Dash buttons, audio beeps, and automatic 2-way encoder/decoder.',
  defaultFontSize: 24,
  sampleText: '... --- ...  /  .-.. . -..- .. -.- . -.--',
  hasPhoneticMode: true,
  phoneticDescription: 'Type regular letters to auto-encode into Morse dots & dashes.',
  specialCharGroups: [
    { title: 'Morse Letters', chars: ['.-', '-...', '-.-.', '-..', '.', '..-.', '--.', '....', '..', '.---', '-.-', '.-..', '--', '-.', '---', '.--.', '--.-', '.-.', '...', '-', '..-', '...-', '.--', '-..-', '-.--', '--..'] },
    { title: 'Morse Numbers', chars: ['.----', '..---', '...--', '....-', '.....', '-....', '--...', '---..', '----.', '-----'] },
    { title: 'Prosigns', chars: ['...---...' /* SOS */, '-.-.-' /* CT */, '.-.-.' /* AR */, '...-.-' /* SK */] }
  ],
  rows: [
    [
      { char: '.', label: '• DOT [E]', width: 'wider' },
      { char: '-', label: '— DASH [T]', width: 'wider' },
      { char: ' ', label: 'Letter Space', width: 'wide' },
      { char: ' / ', label: 'Word Slash (/)' },
      { char: '...---...', label: 'SOS (... --- ...)' },
    ],
    [
      { char: '.-', label: 'A (.-)' },
  ...
  externalLinks: {
    wikipediaLang: 'en',
    lexilogosUrl: 'https://www.lexilogos.com/clavier/morse.htm'
  },
  seoKeywords: ['morse code keyboard', 'morse code translator', 'clavier morse', 'morse audio player online']
};
